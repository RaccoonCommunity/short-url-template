const config = {
  password: "RCshop2022", // 管理面板使用密码 // if password != null, then use this config; otherwise, read password from KV.
  result_page: true, // 是否用特定的result页面来显示value // After get the value from KV, if use a page to show the result.
  theme: "RaccoonCommunity/short-url-template", // 管理面板的主题 // Homepage theme, use the empty value for default theme. To use urlcool theme, please fill with "theme/urlcool" .
...
const html404 = `<!DOCTYPE html>
  ...
  <body>
    ...
    <p>並未找到您所要的頁面，或現已失效！</p>
    <p>請點擊下方按鈕，聯絡客服處理！！</p>
    <p> <a href="https://discord.gg/zZQEnVawua" target="_self">新夜商城 Discord 線上客服</a> </p>
  </body>
  </html>`
